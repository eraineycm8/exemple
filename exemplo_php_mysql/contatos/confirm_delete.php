...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    if ($result->num_rows>0){
        ...
        // SUPER IMPORTANTE NOTAR QUE O TYPE="BUTTON" É CRUCIAL PARA FUNCIONAR COMO CANCELAR PQ SE NÃO POR ESTAR DENTRO DE UM FORM ELE PASSA A SER INTERPRETADO COMO SUBMIT
        echo '<a href="index.php"><button type="button">Cancelar</button></a>'; 
        echo '<button type="button" onclick="enviarDados()">Excluir</button>';
        echo '</form>';
